...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Vérifie si la case à cocher a été cochée
    $isChecked = isset($_POST['checkboxStatus']);

    // Mettez à jour le statut de la tâche en fonction de l'état de la case à cocher
    if ($isChecked) {
        $status = 'Completed';
    } else {
