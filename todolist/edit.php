...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_GET['id'])) {
    ...
    $todos = getTodos();
    // Modifie le titre et la date de la tâche avec l'id passé en paramètre GET avec le titre et date passé en paramètre POST
    $todos[$_GET['id']]['title'] = $_POST['title'];
    $todos[$_GET['id']]['due_date'] = $_POST['due_date'];
